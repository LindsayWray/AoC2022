...
void monkey_business(Monkey &monkey, std::vector<Monkey> &monkeys){
...
int main(){
    ...
    std::sort(inspected.begin(), inspected.end(), std::greater<int>());
