...
int bestScore;
std::set<std::string> todoForElephants;
...
int main(){
    ...
    findRoute(valves["AA"], 26, 0, usefulValves);
    int humanScore = bestScore;
    std::cout << "Human" << humanScore << std::endl;    
    bestScore = 0; // reset for elephant
    findRoute(valves["AA"], 26, 0, todoForElephants);
    int elephantScore = bestScore;
    std::cout << "Elephant" << elephantScore << std::endl;    
    
    std::cout << "Final score: " << humanScore + elephantScore << std::endl;
}